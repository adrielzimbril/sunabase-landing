...
import { GitFork, Fingerprint, ArrowRight } from "lucide-react";
  ...
  return (
    <AuthLayout>
      <div className="w-full">
        <div className="mb-10">
          <h1 className="text-3xl font-semibold mb-3 tracking-tight text-white">Establish Connection</h1>
          <p className="text-gray-400 text-lg">Authenticate to access your Sunabase clusters.</p>
        </div>
        ...
        <div className="relative mb-8 text-center">
          ...
          <span className="relative bg-black px-4 text-xs font-mono text-gray-500 uppercase tracking-widest">or use magic link</span>
        </div>
        ...
        <form className="space-y-5">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="block text-sm font-medium text-gray-400 font-mono">Auth.Key</label>
              <Link href="#" className="text-xs text-emerald-500/80 hover:text-emerald-400 transition-colors font-mono">
                Recover Key?
              </Link>
            </div>
            <input 
        ...
        <p className="mt-10 text-center text-sm text-gray-500">
          No existing nodes?{" "}
          <Link href="/signup" className="inline-flex items-center text-emerald-400 hover:text-emerald-300 font-medium group transition-colors">
            Initialize new node
